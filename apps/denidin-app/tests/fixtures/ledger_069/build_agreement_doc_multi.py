...
PARAS = [
    "הסכם שכר טרחה",
    "",
    "נחתם ביום 22/05/2026 בין משרד עורכי הדין (\"המשרד\") לבין הלקוחה גב' מרים בן שעיה "
...
TAIL = [
    "",
    "התשלומים ישולמו על ידי אביה של הלקוחה, מר איתן רוזן, מבלי לגרוע מאחריות הלקוחה.",
    "",
