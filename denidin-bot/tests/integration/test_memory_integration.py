...
class TestMemorySystemIntegration:
    ...
    def test_session_manager_clears_session(self, temp_storage):
        ...
        history_before = session_manager.get_conversation_history(chat_id, "client")
        ...
        history_after = session_manager.get_conversation_history(chat_id, "client")
    ...
    def test_ai_handler_stores_messages_in_session(self, config_with_memory, test_config):
        ...
        history = ai_handler.session_manager.get_conversation_history(chat_id, 'client')
