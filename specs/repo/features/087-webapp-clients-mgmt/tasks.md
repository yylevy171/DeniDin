...
- [ ] T013 (deferred, not this pass): `apps/webapp/backend/tests/integration/test_clients_api.py`, `apps/webapp/e2e/clients.spec.ts` — full billed/e2e acceptance tests per Feature 087's UAT-1/2/3.
