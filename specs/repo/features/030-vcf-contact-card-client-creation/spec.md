...
- `specs/done/v0.0.1/026-client-management/` (`spec.md`, `user-stories.md`) — the approval-gate and missing-mandatory-field behavior this feature depends on and must not duplicate.
