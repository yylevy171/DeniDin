...
explain it" artifact (matching `specs/done/v0.4.3/047-.../research.md`'s style) won't find it here.
...
"paste the real payload, then explain it" style as `specs/done/v0.4.3/047-.../research.md`'s Gate Zero
