...
- `specs/done/v0.0.1/022-explicit-approval-for-document-creation/` and
  `specs/done/v0.4.3/047-whatsapp-interactive-approval-buttons/` — the approval-gate UX pattern this
  feature reuses for reminder create/modify/delete.
- `specs/done/v0.2.0/033-ledger-event-persistence/` (via `managers/ledger_event_manager.py`) — the
