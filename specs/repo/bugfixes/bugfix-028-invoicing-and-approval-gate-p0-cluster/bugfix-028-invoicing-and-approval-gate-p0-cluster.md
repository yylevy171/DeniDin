...
`specs/done/v0.4.1/bugfix-038-group-b-approval-missing-reference-data.md`). Two minor,
...
## Related Work
- `specs/done/v0.3.0/027-mandatory-client-reference-invoicing/` — introduced
