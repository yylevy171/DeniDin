...
## Bug ID
bugfix-056-webapp-ui-gaps-vs-approved-playwright-plan

> **Note on numbering**: Renumbered from bugfix-052 to 056 due to collision with `bugfix-052-billed-tests-share-one-session-per-file`.
