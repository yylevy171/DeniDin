...
## Related Work
- `specs/done/v0.4.1/bugfix-028-invoicing-and-approval-gate-p0-cluster.md` — B3 (the
...
- `specs/done/v0.0.1/023-reference-linked-document-creation/` — introduced all three Group B tools'
  current reference-by-ID pattern.
- `specs/done/v0.3.0/027-mandatory-client-reference-invoicing/` — `_extract_linked_client_id`,
...
- `specs/done/v0.4.1/bugfix-028-invoicing-and-approval-gate-p0-cluster/bugfix-028-HANDOFF.md`
