...
**Status**: Done - Merged to master (PR #645). Fixed without BDD, per operator instruction. Ships in the next release (version chosen by the human). Prod was brought onto the fixed compose (baked config, no host overrides) on 0.7.6 on 2026-09-26; stale box copies deleted.
