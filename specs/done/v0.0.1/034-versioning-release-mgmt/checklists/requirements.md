...
- [ ] Written for non-technical stakeholders — **partial pass, by design**: this is an
      ...
      house style for this class of spec (compare `specs/done/v0.0.1/030-.../spec.md`, which is similarly
...
- Two items are marked partial-pass rather than full-pass, both by deliberate design rather than
  ...
  established style of comparable specs in this repo (e.g. `specs/done/v0.0.1/030-.../spec.md`) rather
