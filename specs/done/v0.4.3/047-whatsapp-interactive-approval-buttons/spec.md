...
- `specs/done/v0.0.1/022-explicit-approval-for-document-creation/` — the gate this plugs into.
- `specs/done/v0.2.3/046-hebrew-approval-synonyms/` — widened the affirmative whitelist; the layer this
  feature would make largely unnecessary for tapped approvals.
- `specs/done/v0.4.1/bugfix-028-invoicing-and-approval-gate-p0-cluster.md` — **B1** and
