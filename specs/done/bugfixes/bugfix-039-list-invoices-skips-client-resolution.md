...
- `specs/done/031-fuzzy-client-lookup-by-name/` — the feature that investigated the original
...
**This was already investigated once, in Feature 031 (`specs/done/031-fuzzy-client-lookup-by-name/`),
...
- ✅ Feature 031's `research.md` Decision 1 gap is now documented here (see note above) rather than
  edited in place — `specs/done/031-fuzzy-client-lookup-by-name/` itself was left untouched
