...
## Related Work
- `specs/done/v0.0.1/018-denidin-morning-mcp-integration/` — audit logging was already listed there as
  outstanding polish. This bug is the evidence that it matters.
- `specs/done/v0.4.1/bugfix-028-invoicing-and-approval-gate-p0-cluster.md` — A4 needs the same
