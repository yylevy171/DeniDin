...
EXPENSIVE=(
  ...
  "den|tests/expensive/test_e2e_media_client_resolution.py::TestMediaClientResolutionE2E::test_us7a_deposit_image_zero_matches_new_client"
  "den|tests/expensive/test_e2e_media_client_resolution.py::TestMediaClientResolutionE2E::test_us9_photographed_multi_component_agreement"
