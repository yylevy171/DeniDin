...
FAIL_FILE="${ROOT}/specs/backlog/059-stabilize-tests-sanity-suite/sanity-failures.md"
...
BILLED=(
  ...
  "den|tests/billed/test_denidin_morning_invoice_creation_e2e.py::test_create_document_for_existing_client_happy_path"
  "den|tests/billed/test_denidin_morning_invoice_creation_e2e.py::test_create_document_for_new_client_full_flow_happy_path"
  "den|tests/billed/test_denidin_morning_invoice_creation_e2e.py::test_create_document_for_new_client_asked_for_missing_info_then_provided"
  ...
  "den|tests/billed/test_ledger_query_billed.py::TestLedgerQueryBilled::test_hours_by_client_this_month"
